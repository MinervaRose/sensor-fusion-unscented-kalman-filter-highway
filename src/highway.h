...
public:
	...
	std::vector<bool> trackCars = {true,true,true}; //I commented it out to tracl only one car at first
	//std::vector<bool> trackCars = {true,false,false};  // track only first car
